...
IMAGE_TYPEDEP_my-image = "${SDIMG_ROOTFS_TYPE}"
...
do_image_my_image[recrdeps] = "do_build"

# SD card image name
SDIMG = "${IMGDEPLOYDIR}/${IMAGE_NAME}.rootfs.my-image"

# Compression method to apply to SDIMG after it has been created. Supported
# compression formats are "gzip", "bzip2" or "xz". The original .my-image file
